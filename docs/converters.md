...
| Source \ Target | Codex | Pi | OpenCode | Claude |
|---|---|---|---|---|
| **Codex** | -- | CodexToPi | CodexToOpenCode | CodexToClaude |
| **Pi** | PiToCodex | -- | PiToOpenCode | PiToClaude |
| **OpenCode** | OpenCodeToCodex | OpenCodeToPi | -- | OpenCodeToClaude |
| **Claude** | ClaudeToCodex | ClaudeToPi | ClaudeToOpenCode | -- |
